...
h_ber_plot = figure;
semilogy(EbN0_dB,bers(1,:),'color', C(1,:))
hold on
semilogy(EbN0_dB,bers(2,:),'-s','color', C(2,:))
semilogy(EbN0_dB,bers(3,:),'-^','color', C(3,:))
semilogy(EbN0_dB,bers(4,:),'-v','color', C(4,:))
semilogy(EbN0_dB,bers(5,:),'-p','color', C(5,:))
hold on
...
export_fig(['BER_Curves_' num2str(N_SYMBOLS) '.pdf'],'-painters','-transparent')
